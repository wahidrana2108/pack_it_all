...
<?php
    ...
    while($row_cart = mysqli_fetch_array($run_cart)){
        ...
        while($row_products = mysqli_fetch_array($run_products)){
            ...
            $insert_customer_order = "insert into customer_order ( customer_id,due_ammount,invoice_no,qty,size,order_date,order_status ) values ('$customer_id','$sub_total','$invoice_no','$pro_qty','$pro_size',NOW(),'$status')";
