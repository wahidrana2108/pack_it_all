<div class="">
  ...
  <div class="row">
    <div class="col-sm-6 col-md-9">
      <table class="table table-striped table-hover text-center">
        ...
        <tr>
          <td><a href='#'><img style="width: 60px;" src="admin_area/product_images/<?php echo $product_img1; ?>" alt="..."><br></a><?php echo $product_title; ?></td>
          <td>
            <h6><?php echo $pro_qty; ?></h6>
          </td>
          <td>
      ...
      function update_cart(){
        ...
        if(isset($_POST['update'])){
          foreach($_POST['remove'] as $remove_id){
            $delete_product = "delete from cart from where p_id='$remove_id'";
    ...
    <div class="col-sm-6 col-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <h6>Order Sub-Total: <span class="justify-content-right fw-bolder">৳<?php echo $total; ?></span></h6>
          <hr>
          <h6>Shipping Cost: <span class="justify-content-right fw-bolder">৳50</span></h6>
          <hr>
          <h6>Tax: <span class="justify-content-right fw-bolder">৳<?php echo $tax; ?></span></h6>
          <hr>
  ...
  <div class="mt-3">
    ...
    <div class="btn-group">
      ...
      <a href="cart.php" class="btn btn-primary btn-sm mb-1" role="button"><i
          class="fa-solid fa-rotate-right me-1"></i>Refresh</a>
