...
<ul class="navbar-nav navbar-dark bg-dark ps-3 pe-3 vh-100">
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle active text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-pen-to-square pe-3"></i> Products Category</a>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?insert_product_category">Insert Products Category</a></li>
            <li><a class="dropdown-item" href="index.php?view_product_categories">View Products Categories</a></li>
        </ul>
    </li>
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle active text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-book pe-3"></i> Category</a>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?insert_category">Insert Category</a></li>
            <li><a class="dropdown-item" href="index.php?view_categories">View Categories</a></li>
        </ul>
    </li>
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle active text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-gear pe-3"></i> Slides</a>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?insert_slide">Insert Slide</a></li>
